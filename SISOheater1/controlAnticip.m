...
% tclab mediante un control anticipativo
close all
...
Ti = 75;  
Ts = 2;
ku=tf([0.646*240, 0.646],1);
kq=tf([0.2622*150, 0.2622],1);
...
for k = 1:1:nIter
    ...
    % inicio de perturbacion
 
     if k>=150
       u2(k)=25;
       h2(u2(k));
       up(k)=(0.221*u2(k)-0.218*u2(k-1)+0.9917*up(k-1));
     end
     % fin de perturbacion
     if k>=300 || k<150
       u2(k)=0;
