% El objetivo de este script es realizar la simulacion del control 
% de temperatura en una tclab mediante un controlador PI y un predictor de 
% Smith
close all
clear all
...
for k = 1:1:nIter
    ...
    if k > 1  
    ym(k)=0.9868*ym(k-1) + 0.008557*u(k-1);
    end
    % Control  de error
   yl(k)=yp(k)+23.74;
