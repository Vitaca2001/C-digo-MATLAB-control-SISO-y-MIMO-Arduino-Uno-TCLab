% El objetivo de este scrip es crear una simulacon  de control lqr en  
% combinación con un PI para llegar a consigna. Sin tener en cuenta los 
% retardos
clear all
close all
